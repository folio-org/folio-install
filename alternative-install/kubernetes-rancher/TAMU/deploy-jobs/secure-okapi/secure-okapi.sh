...
{
  "srvcId" : "mod-users-19.0.0",
  "instId" : "mod-users-19.0.0",
  "url" : "http://mod-users-19-0-0:8081"
}
END

cat > deployment-descriptor-permissions.json <<END
{
  "srvcId" : "mod-permissions-6.2.0",
  "instId" : "mod-permissions-6.2.0",
  "url" : "http://mod-permissions-6-2-0:8081"
}
END

cat > deployment-descriptor-login.json <<END
{
  "srvcId" : "mod-login-7.8.0",
  "instId" : "mod-login-7.8.0",
  "url" : "http://mod-login-7-8-0:8081"
}
END

cat > deployment-descriptor-authtoken.json <<END
{
  "srvcId" : "mod-authtoken-2.12.0",
  "instId" : "mod-authtoken-2.12.0",
  "url" : "http://mod-authtoken-2-12-0:8081"
}
END
