...
### mod-authtoken
Startup Options:<br/>
JAVA_OPTIONS = -Djwt.signing.key=foo -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap -Dcache.permissions=true<br/>
Database connection: No<br/>
Port: 8081<br/>
Health Check endpoint: NA
...
### mod-inventory
Startup Options:<br/>
JAVA_OPTIONS = -Dorg.folio.metadata.inventory.storage.type=okapi -Xmx2048m<br/>
Database connection: No<br/>
Port: 9403<br/>
Health Check endpoint: NA
