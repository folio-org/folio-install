...
1. Build a list of frontend modules to enable
  ...
  * [Sample perl script](gen-module-list.pl) to generate JSON array from Stripes build
```
...
4. Create deployment descriptors with the versions of the modules returned from the Okapi install endpoint
  ...
  * [Sample perl script](gen-deploy-descrs.pl) to generate module descriptors
```
perl /vagrant/gen-deploy-descrs.pl full-install.json /vagrant/deployment-descriptor-templates
```
